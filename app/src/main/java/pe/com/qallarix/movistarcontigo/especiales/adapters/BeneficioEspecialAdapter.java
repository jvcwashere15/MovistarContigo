package pe.com.qallarix.movistarcontigo.especiales.adapters;
...
public class BeneficioEspecialAdapter extends RecyclerView.Adapter<BeneficioEspecialAdapter.BeneficioEspecialHolder> {

    private ClickBeneficioEspecial clickBeneficioEspecial;
    private Context context;
    private List<SpecialBenefit> specialBenefits;

    public BeneficioEspecialAdapter(Context context, List<SpecialBenefit> specialBenefits,ClickBeneficioEspecial clickBeneficioEspecial) {

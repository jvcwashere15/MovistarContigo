 ...
 */
public class HogarPasosFragment extends Fragment {
    ...
    public HogarPasosFragment() {
        // Required empty public constructor
    }


    public static HogarPasosFragment newInstance(SelfhelpList selfhelpList, int numero) {
        Bundle args = new Bundle();
        args.putSerializable(ARGUMENT_SELFHELPLIST,selfhelpList);
        args.putInt(ARGUMENT_NUMERO,numero);
        HogarPasosFragment fragment = new HogarPasosFragment();

...
public class SolicitudAprobacion {
    ...
    public String getOutOfDateApproval() {
        return outOfDateApproval;
    }

    public void setOutOfDateApproval(String outOfDateApproval) {
        this.outOfDateApproval = outOfDateApproval;
    }
    ...
    public String getRequestDateMaximun() {
        return requestDateMaximun;
    }

    public void setRequestDateMaximun(String requestDateMaximun) {
        this.requestDateMaximun = requestDateMaximun;
    }

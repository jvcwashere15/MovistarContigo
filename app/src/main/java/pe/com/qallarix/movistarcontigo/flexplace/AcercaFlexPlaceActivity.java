...
public class AcercaFlexPlaceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_acerca_flex_place);
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(AcercaFlexPlaceActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (PermissionUtils.neverAskAgainSelected(AcercaFlexPlaceActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    Intent intent = new Intent(AcercaFlexPlaceActivity.this, PdfActivity.class);
        ...
        Dexter.withActivity(this).withPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .withListener(new BasePermissionListener(){
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        PermissionUtils.setShouldShowStatus(AcercaFlexPlaceActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                    }
                }).check();
    }

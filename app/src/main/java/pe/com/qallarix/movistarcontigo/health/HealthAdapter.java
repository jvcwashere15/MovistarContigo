...
public class HealthAdapter extends RecyclerView.Adapter<HealthAdapter.ItemSaludHolder> {
    ...
    public HealthAdapter(Context context, List<Plan> planes, SaludClick saludClick) {

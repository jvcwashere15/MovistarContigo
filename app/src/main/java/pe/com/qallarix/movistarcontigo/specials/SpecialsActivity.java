...
import pe.com.qallarix.movistarcontigo.specials.adapters.SpecialBenefitAdapter;
...
public class SpecialsActivity extends TranquiParentActivity {
    ...
    private void cargarMenuBeneficiosEspeciales() {
        SpecialBenefitAdapter beneficioEspecialAdapter = new SpecialBenefitAdapter(
                SpecialsActivity.this,
                specialBenefits,
                new SpecialBenefitAdapter.ClickBeneficioEspecial() {
                    @Override
                    public void onClick(int position, View view) {
                        SpecialBenefit currentSpecialBenefit = specialBenefits.get(position);
                        Intent intent = new Intent(SpecialsActivity.this, SpecialDetailActivity.class);

...
import pe.com.qallarix.movistarcontigo.ambassador.mobile.pojos.CharacteristicGroupList;
import pe.com.qallarix.movistarcontigo.ambassador.mobile.pojos.CharacteristicList;
import pe.com.qallarix.movistarcontigo.ambassador.mobile.pojos.OfferList;

/**
 * A simple {@link Fragment} subclass.
 */
public class MobilePacksFragment extends Fragment {
    ...
    public MobilePacksFragment() {
        // Required empty public constructor
    }

    public static MobilePacksFragment newInstance(OfferList paqueteMovil) {
        Bundle args = new Bundle();
        args.putSerializable(ARGUMENT_PAQUETE_MOVIL,(Serializable) paqueteMovil);
        MobilePacksFragment fragment = new MobilePacksFragment();

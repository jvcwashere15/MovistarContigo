...
public class ImportanteAdapter extends RecyclerView.Adapter<ImportanteAdapter.ImportanteHolder> {

    private List<SelfhelpList> importantes;
    private Context context;

    public ImportanteAdapter(List<SelfhelpList> importantes, Context context) {

...
public class RechazoSolicitudFlexActivity extends AppCompatActivity {
    ...
    private void mostrarDialogError() {
        final AlertDialog.Builder builder = new AlertDialog
                .Builder(RechazoSolicitudFlexActivity.this);
    ...
    public void mostrarDialogRechazarFlexPlace(){
        ...
        builder.setPositiveButton("Continuar", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                Intent intent = new Intent(RechazoSolicitudFlexActivity.this,

...
public class DetalleNoticiaActivity extends TranquiParentActivity {
        ...
        call.enqueue(new Callback<DataNews>() {
            ...
            public void onResponse(Call<DataNews> call, Response<DataNews> response) {
                if (response.code() == 200){
                    ...
                    Toast.makeText(DetalleNoticiaActivity.this, "Error al obtener la noticia", Toast.LENGTH_SHORT).show();
                    finish();
                }
            }
    ...
    private void cargarlistaOtrasNoticias(final List<News> news) {
        if (news!=null && news.size()>0){
            NoticiasTambienAdapter noticiasTambienAdapter =
                    new NoticiasTambienAdapter(news, DetalleNoticiaActivity.this,
                            new NoticiasTambienAdapter.NotiTambienClick() {
                                @Override
    ...
    private void displayNoticiaImagenes() {
        ...
        ImagenNoticiasAdapter imagenNoticiasAdapter = new ImagenNoticiasAdapter(getSupportFragmentManager(),imagenesNoticias);

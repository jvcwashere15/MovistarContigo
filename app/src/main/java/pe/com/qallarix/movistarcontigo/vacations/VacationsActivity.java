...
public class VacationsActivity extends TranquiParentActivity {
    ...
    private void cargarDatosVacaciones() {
        ...
        Call<VacacionesDashboard> call = WebServiceVacations
                .getInstance(getDocumentNumber())
                .createService(ServiceVacationsApi.class)
    ...
    private void configurarBotonRegistroVacaciones() {
        vRegistro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(VacationsActivity.this, RegisterVacationsActivity.class);
    ...
    private void configurarBotonEstadoVacaciones() {
        vEstado.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(VacationsActivity.this, PendingRequestsActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    private void configurarBotonAprobacionVacaciones() {
        vAprobacion.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent =  new Intent(VacationsActivity.this, ForApproveVacationsActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public void verInformacionImportante(View view) {
        Intent intent = new Intent(this, AboutVacationsActivity.class);

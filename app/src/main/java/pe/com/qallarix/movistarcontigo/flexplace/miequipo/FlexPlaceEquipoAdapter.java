...
public class FlexPlaceEquipoAdapter extends RecyclerView.Adapter<FlexPlaceEquipoAdapter.FlexPlaceEquipoHolder> {
    Context context;
    List<FlexEquipo> solicitudFlexes;
    FlexEquipoOnClick flexEquipoOnClick;

    public FlexPlaceEquipoAdapter(Context context, FlexEquipoOnClick flexEquipoOnClick) {

...
public class BulletPointDescriptionAdapter extends RecyclerView.Adapter<BulletPointDescriptionAdapter.VinetaHolder> {
    List<String> vinetas;

    public BulletPointDescriptionAdapter(List<String> vinetas) {

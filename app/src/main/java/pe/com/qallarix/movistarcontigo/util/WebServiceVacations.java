...
public class WebServiceVacations {
    ...
    private static WebServiceVacations instance;
    ...
    public static void setInstance(WebServiceVacations instance) {
        WebServiceVacations.instance = instance;
    }

    public WebServiceVacations(String dni){
        mDni = dni;
    ...
    public static synchronized WebServiceVacations getInstance(String dni){
        if (instance == null)
            instance = new WebServiceVacations(dni);
        return instance;
    }

    ...
    private void configurarBotonOpenPdf(TextView textView, final String title, final String file) {
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ContextCompat.checkSelfPermission(AboutVacationsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (PermissionUtils.neverAskAgainSelected(AboutVacationsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                    ...
                    Intent intent = new Intent(AboutVacationsActivity.this, PdfActivity.class);
        ...
        Dexter.withActivity(this).withPermission(Manifest.permission.WRITE_EXTERNAL_STORAGE)
                .withListener(new BasePermissionListener(){
                    ...
                    public void onPermissionDenied(PermissionDeniedResponse response) {
                        PermissionUtils.setShouldShowStatus(AboutVacationsActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
                    }
                }).check();
    }
}

 ...
 */
public class HomePackFragment extends Fragment {
    ...
    public HomePackFragment() {
        // Required empty public constructor
    }

    public static HomePackFragment newInstance(PaqueteHogar paqueteHogar) {
        Bundle args = new Bundle();
        args.putSerializable(ARGUMENT_PAQUETE_HOGAR, (Serializable) paqueteHogar);
        HomePackFragment fragment = new HomePackFragment();

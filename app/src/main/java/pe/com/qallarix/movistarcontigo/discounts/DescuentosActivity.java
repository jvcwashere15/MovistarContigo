...
//        });
    ...
    private void cargarDescuentos() {
        if (discounts.isEmpty()) {
            ...
            descuentoAdapter = new DiscountAdapter(rvDescuentos, DescuentosActivity.this, discounts,
                    DescuentosActivity.this, sizePage, new DiscountAdapter.ClickDescuento() {
                @Override
...
//            @Override
//            public void onClick(View v) {
//                Intent intent = new Intent(DescuentosActivity.this,AccountActivityView.class);
//                startActivity(intent);
//            }
//        });

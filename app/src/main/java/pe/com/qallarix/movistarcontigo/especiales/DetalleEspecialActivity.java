...
import pe.com.qallarix.movistarcontigo.especiales.adapters.TipoBeneficioAdapter;
import pe.com.qallarix.movistarcontigo.especiales.fragments.BeneficioFragment;
import pe.com.qallarix.movistarcontigo.especiales.fragments.ContactoFragment;
import pe.com.qallarix.movistarcontigo.especiales.pojos.BenefitDetail;
import pe.com.qallarix.movistarcontigo.especiales.pojos.ItemList;
import pe.com.qallarix.movistarcontigo.especiales.pojos.SpecialBenefits;
...
public class DetalleEspecialActivity extends TranquiParentActivity {
        ...
        call.enqueue(new Callback<BenefitDetail>() {
            ...
            public void onResponse(Call<BenefitDetail> call, Response<BenefitDetail> response) {
                if (response.code() == 200){
                    ...
                    Toast.makeText(DetalleEspecialActivity.this, "Error al cargar el detalle del beneficio", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void displayImagenBeneficioEspecial(String urlImage){
        ...
        try{
            Picasso.with(DetalleEspecialActivity.this)
                    .load(urlImage)
    ...
    public void getDataIntent(){
        ...
        idBeneficio = bundle.getLong(EspecialesActivity.KEY_DETALLE_BENEFICIO_ID, 0);
    }
